...
export default function IndustryDetailPageContent({ slug }: { slug: MarketingIndustrySlug }) {
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <section className="relative bg-white px-4 py-16 sm:py-24">
        <div className="mx-auto max-w-container text-center">
          ...
          <div className="flex flex-col items-center justify-center gap-3 sm:flex-row sm:flex-wrap">
            <Button asChild size="lg" variant="primary" className="bg-fynk-orange text-white hover:bg-fynk-orange-hover">
