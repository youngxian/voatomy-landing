...
function NexusAIWorkflow() {
  ...
  return (
    <Section variant="fynk-alt" className="py-20 sm:py-28 overflow-hidden">
      <div ref={ref}>
...
export default function NexusProductPage() {
  ...
  return (
    <main className="relative overflow-hidden dark-section">
      ...
      {/* ─── 2. PRODUCT UNIVERSE ─── */}
      <Section variant="fynk-alt" id="universe" className="py-24 sm:py-32 bg-[#080c0a]">
        <div
          ref={universe.ref}
          className={cn(
      ...
      <Section variant="fynk-alt" className="py-24 sm:py-32 bg-[#0a0a0a]">
        <div
          ref={unified.ref}
          className={cn(
            "transition-all duration-700",
      ...
      {/* ─── 4. THE FULL STACK ─── */}
      <Section variant="fynk-alt" className="py-24 sm:py-32 bg-[#080c0a]">
        <div
          ref={stack.ref}
          className={cn(
            "transition-all duration-700",
      ...
      {/* ─── 9. CONTACT SALES CTA ─── */}
      <Section variant="fynk-alt" id="contact" className="py-24 sm:py-32 bg-[#0a0a0a]">
        <div
          ref={cta.ref}
          className={cn(
            "transition-all duration-700",
