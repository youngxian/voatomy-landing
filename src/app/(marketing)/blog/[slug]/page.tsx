...
const BLOG_POSTS: Record<
  string,
  { title: string; description: string; author: string; date: string; readTime: string; category: string; body: string[] }
> = {
  ...
  "revenue-weighted-backlogs": {
    ...
    description: "How to attach revenue signals to every backlog item so your team always ships what matters most to the business.",
    author: "Maya Chen",
    date: "Dec 28, 2025",
    readTime: "6 min read",
    category: "Product",
  ...
  "tech-debt-business-problem": {
    ...
    description: "Framing tech debt as an engineering concern loses the argument every time. Here's how to speak the language leadership actually understands.",
    author: "James Okafor",
    date: "Dec 20, 2025",
    readTime: "7 min read",
    category: "Culture",
